...
I built a single-page application that uses React state, props, Hooks, and reusable UI components. This was built as part of the lesson plan for the coding bootcamp I'm in.
...
[My GitHub Page Link](https://amymgardiner.github.io/Photo-Port/)
